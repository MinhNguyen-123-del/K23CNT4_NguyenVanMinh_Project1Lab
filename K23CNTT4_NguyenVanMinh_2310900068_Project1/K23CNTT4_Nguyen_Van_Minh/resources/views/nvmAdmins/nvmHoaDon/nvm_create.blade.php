...
@section('title','Danh sach Hóa Đơn')
            ...
            <div class="col">
              <form action="{{route('nvmadmins.nvmhoadon.nvmeditsubmit')}}" method="post">
                    ...
                    <div class="card-header">
                        <h2>Danh sach Hóa Đơn</h2>
                    </div>
                    <div class="card-body container-fluid">
                        <div class="mb-3 row">
                            <label for="nvmMaHoaDon" class="col-sm-2 col-form-label">Mã Hóa Đơn</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="nvmMaHoaDon" name="nvmMaHoaDon">
                            </div>  
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="nvmNgayHoaDon" name="nvmNgayHoaDon" value="{{ old('nvmNgayHoaDon') ?? date('Y-m-d') }}">
                            </div>  
                        </div>   
                        <div class="mb-3 row">
                            <label for="nvmNgayNhan" class="col-sm-2 col-form-label">Ngày Nhận</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="nvmNgayNhan" name="nvmNgayNhan" value="{{ old('nvmNgayNhan') ?? date('Y-m-d') }}">
                            </div>  
                        </div>               
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nvmTongTriGia" name="nvmTongTriGia" value="1">
                                    @error('nvmTongTriGia')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                                </div>
